...
class BambuBootstrap:
    ...
    def Bootstrap(logger:logging.Logger, config:Config) -> None:
        ...
        if config.GetStr(Config.SectionBambu, Config.BambuPrinterSn, None) is None:
            ...
            logger.error("")
            logger.error("      To find your Serial Number -> https://OctoApp.com/s/bambu-sn")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
        ...
        if config.GetStr(Config.SectionBambu, Config.BambuAccessToken, None) is None:
            ...
            logger.error("")
            logger.error("      To find your Access Code -> https://OctoApp.com/s/access-code")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
            # Sleep some, so we don't restart super fast and then exit.
        ...
        if printerIp is None:
            ...
            logger.error("")
            logger.error("    To find your printer's IP Address -> https://OctoApp.com/s/bambu-ip")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
            # Sleep some, so we don't restart super fast and then exit.
