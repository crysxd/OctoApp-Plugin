...
from bambu_octoapp.bambucloud import BambuCloud
...
class BambuBootstrap:
    ...
    def Bootstrap(logger:logging.Logger, config:Config) -> None:
        ...
        if config.GetStr(Config.SectionBambu, Config.BambuPrinterSn, None) is None:
            ...
            logger.error("")
            logger.error("      To find your Serial Number -> https://github.com/crysxd/OctoApp-Plugin/wiki/Installation-for-BambuLab#finding-your-serial-number")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
        ...
        if config.GetStr(Config.SectionBambu, Config.BambuAccessToken, None) is None:
            ...
            logger.error("")
            logger.error("      To find your Access Code -> https://github.com/crysxd/OctoApp-Plugin/wiki/Installation-for-BambuLab#finding-your-access-code")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
            # Sleep some, so we don't restart super fast and then exit.
        ...
        if printerIp is None:
            ...
            logger.error("")
            logger.error("    To find your printer's IP Address -> https://github.com/crysxd/OctoApp-Plugin/wiki/Installation-for-BambuLab#finding-your-bambu-lab-printers-ip-address")
            logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
            logger.error("")
            logger.error("")
            # Sleep some, so we don't restart super fast and then exit.
            ...
            if lanOnlyMode is not None:
                ...
                if configMode is not None:
                    if configMode == "cloud":
                        ...
                        useBambuCloud = False
                    logger.info(f"Connection mode found in the OctoApp config as `{configMode}`.")
                else:
        ...
        if useBambuCloud:
            ...
            if bambuCloudEmail is None:
                ...
                logger.error("                 and are NEVER SENT to the OctoApp service.")
                logger.error("")
                logger.error("       For Help And More Details -> https://OctoApp.com/s/bambu-setup")
                logger.error("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
                logger.error("")
                logger.error("")
                # Sleep some, so we don't restart super fast and then exit.
