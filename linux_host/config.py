...
class Config:
    ...
    c_ConfigComments = [
        ...
        { "Target": ElegooCc2AccessCode,  "Comment": "The LAN only access code to the Elegoo Centauri Carbon 2 printer."},
        { "Target": ElegooCc2PrinterSn,  "Comment": "The serial number of your Elegoo Centauri Carbon 2 printer. If blank, OctoApp will try to discover it from the printer IP."},
