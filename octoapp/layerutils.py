...
class LayerUtils:
    ...
    def IsLayerChange(line:str, context:Dict[str,Any]) -> bool:
        ...
        if line.startswith(";Sliced by ideaMaker"):
            context["slicer"] = "ideaMaker"
