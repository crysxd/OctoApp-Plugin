...
class Configure:
    ...
    def Run(self, context:Context) -> None:
        ...
        # All services start with octoapp (c_ServiceCommonName) but they have different suffixes so they don't collide if there
        ...
        if context.IsCompanionBambuOrElegoo():
            ...
            context.RootFolder = os.path.join(Util.GetParentDirectory(context.ConfigFolder), f"octoapp_data{serviceSuffixStr}")
        ...
        context.LocalFileStorageFolder = os.path.join(context.RootFolder, "octoapp-store")
        ...
        if os.path.exists(context.LogsFolder) is False:
            ...
            if os.path.exists(context.LogsFolder) is False:
                ...
                if os.path.exists(context.LogsFolder) is False:
                    ...
                    context.LogsFolder = os.path.join(context.RootFolder, "octoapp-logs")
