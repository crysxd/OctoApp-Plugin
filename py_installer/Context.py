...
class Context:
    ...
    # This is so the first instance will have a normal name like "octoapp-bambu" instead of "octoapp-bambu-1"
    ...
    def __init__(self) -> None:
        ...
        # This is the name of this OctoApp instance's service.
    ...
    def DetectOsType(self):
        #
        # Note! This should closely resemble the ostypeidentifier.py class in the octoapp module AND the logic in the ./install.sh script!
        #
