...
class BambuConnector:
    ...
    def _SetupNewBambuConnection(self, context:Context) -> Tuple[str, str, str, str]:
        while True:
            ...
            Logger.Header("##################################")
            Logger.Blank()
            Logger.Info("OctoApp Bambu Connect needs to connect to your Bambu Lab printer to provide notifications.")
            Logger.Info("Bambu Connect needs your printer's Access Code and Serial Number to connect to your printer.")
            Logger.Info("If you have any trouble, we are happy to help! Contact us at hello@octoapp.eu")
            ...
            while True:
                ...
                Logger.Warn("https://github.com/crysxd/OctoApp-Plugin/wiki/Installation-for-BambuLab")
                Logger.Blank()
            ...
            while True:
                ...
                Logger.Warn("https://github.com/crysxd/OctoApp-Plugin/wiki/Installation-for-BambuLabInstallation-on-BambuLab")
                Logger.Blank()
