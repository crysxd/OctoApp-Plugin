...
class ElegooConnector:
    ...
    def _ShowTooManyClientsError(self, ip:str) -> None:
        ...
        Logger.Info("Before you can complete the OctoApp setup, we need to allow the installer to connect.")
        Logger.Blank()
        ...
        while True:
            ...
            Logger.Blank()
            Logger.Info("If need help, contact our support team hello@octoapp.eu or join our Discord for help!")
            Logger.Blank()
    ...
    def _SetupNewElegooConnection(self, context:Context) -> Tuple[str, str]:
        while True:
            ...
            while True:
                ...
                Logger.Info("https://github.com/crysxd/OctoApp-Plugin/wiki/")
                Logger.Blank()
