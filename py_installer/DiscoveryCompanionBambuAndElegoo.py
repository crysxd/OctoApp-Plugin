...
class DiscoveryCompanionBambuAndElegoo:
    ...
    c_CompanionPluginDataRootFolder_Lower = ".octoapp-companion"
    c_BambuPluginDataRootFolder_Lower = ".octoapp-bambu"
    c_ElegooPluginDataRootFolder_Lower = ".octoapp-elegoo"
